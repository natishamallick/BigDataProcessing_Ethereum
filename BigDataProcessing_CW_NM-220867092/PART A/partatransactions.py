"""CW - TimeAnalysis- Part A- Number of Transactions
"""
...
if __name__ == "__main__":
    ...
    clean_lines = transac.filter(check_transaction)
    ...
    result_object = bucket_resource.Object(s3_bucket,'ethereum_' + date_time + '/transactions_total.txt')
    result_object.put(Body=json.dumps(total_transactions.take(100)))
